using DEMOSJsonReader
using Documenter

DocMeta.setdocmeta!(DEMOSJsonReader, :DocTestSetup, :(using DEMOSJsonReader); recursive = true)
...
makedocs(;
    modules = [DEMOSJsonReader],
    authors = "Anton Reinhard <a.reinhard@hzdr.de>",
    repo = "https://github.com/Democratizing-Models/DEMOSJsonReader.jl/blob/{commit}{path}#{line}",
    sitename = "DEMOSJsonReader.jl",
    format = Documenter.HTML(; canonical = "https://Democratizing-Models.github.io/DEMOSJsonReader.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/Democratizing-Models/DEMOSJsonReader.jl")
